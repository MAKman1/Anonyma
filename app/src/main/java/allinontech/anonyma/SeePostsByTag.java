...
public class SeePostsByTag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_posts_by_tag);


        swiperefresh = findViewById(R.id.swiperefresh);
        recycler = findViewById( R.id.userRecycler);
        currentTName = findViewById( R.id.currentTagName);
        back = findViewById( R.id.back);
        noPosts = findViewById( R.id.noPosts);

        currentTagName = getIntent().getStringExtra("TAG_NAME");

        if( currentTagName != null){
            currentTName.setText( currentTagName.toUpperCase());
        }
    ...
    public void refreshEverything(){
        if( HomeScreen.userCity != null){
            baseQuery = firestore.collection( "tags").document( currentTagName).collection( "posts").orderBy( "timeStamp",Query.Direction.DESCENDING);
            ...
            options = new FirestorePagingOptions.Builder<String>()
                    .setLifecycleOwner( SeePostsByTag.this)
                            ...
                            if( snapshot != null && snapshot.exists()){
                                ...
                                if (id != null && text != null && image != null && likes != null && comments != null && dateTime != null &&
                                    ...
                                    if( url.equals( "")){
                                        ...
                                        Glide.with( SeePostsByTag.this).load( url).apply(options).into( holder.secretImage);
                                    ...
                                    holder.unameText.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            Intent intent = new Intent( SeePostsByTag.this, UserPosts.class);
                                    ...
                                    holder.commentLikeStat.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            Intent intent = new Intent( SeePostsByTag.this, SeePostStats.class);
                                        ...
                                        public void onClick(View view) {
                                            if( isNetworkAvailable()){
                                                ...
                                                if( randomUserId.equals( HomeScreen.UserId)){
                                                    Toast.makeText( SeePostsByTag.this, "This secret is by you, so please don't try talking to yourself here...", Toast.LENGTH_SHORT).show();
                                                } else{
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            if( dataSnapshot.exists()){
                                                                if( dataSnapshot.hasChild( randomUserId)){
                                                                    ...
                                                                    final Intent i = new Intent( SeePostsByTag.this, ChatWindow.class);

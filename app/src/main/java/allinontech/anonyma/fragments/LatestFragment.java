...
public class LatestFragment extends Fragment {
    ...
    public void refreshEverything(){
        baseQuery = firestore.collection("posts").orderBy("timeStamp", Query.Direction.DESCENDING);
        ...
        options = new FirestorePagingOptions.Builder<Post>()
                ...
                .setQuery(baseQuery, config, new SnapshotParser<Post>() {
                    @NonNull
                    @Override
                    public Post parseSnapshot(@NonNull DocumentSnapshot snapshot) {
                        if( snapshot != null){
                            ...
                            if( id != null && text != null && image != null && likes != null && comments != null && dateTime != null &&
                                ...
                                return new Post(  id.toString(), image.toString(), text.toString(), dateTime.toString(),
        ...
        adapter = new FirestorePagingAdapter<Post, ViewHolder>(options) {
            @NonNull
            @Override

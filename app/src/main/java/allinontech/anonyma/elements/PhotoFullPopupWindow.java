...
import allinontech.anonyma.GlideApp;
import allinontech.anonyma.R;
import allinontech.anonyma.elements.Constants;
...
public class PhotoFullPopupWindow extends PopupWindow {
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        super(((LayoutInflater) ctx.getSystemService(LAYOUT_INFLATER_SERVICE)).inflate( R.layout.photo_popup_for_zoom, null), ViewGroup.LayoutParams.MATCH_PARENT,
